...
const Dashboard = () => {
  ...
  const notificationState = useSelector(
    (state: any) => state.mainState.newNotification
  );
  ...
  useEffect(() => {
    const checkMessages = () => {
      messagesData.length > 0
        ? dispatch(MessageState("messages-true"))
        : dispatch(MessageState("messages-false"));
    };
            ...
            <Link to="/">
              <li>
                <div className="iconWrapper">
                  <SVGIcon
                    name="menuIcon"
                    className={`menu-icon ${path === "/" ? "active-menu" : ""}`}
                    size={30}
                  />
                </div>
                <span>Главная</span>
              ...
              <li>
                <div className="iconWrapper">
                  <SVGIcon
                    name="notification"
                    className={`menu-icon ${
                      path === "/notifications" ? "active-menu" : ""
                    }`}
                  />
                  {notificationState ? (
                    <div className="pinnedItem"></div>
