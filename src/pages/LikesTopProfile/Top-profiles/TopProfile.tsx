				...
				<div className='PagesWrapper'>
					...
					<div className='bannerGold'>
						<div className='bannerDescription'>
							<p>Перейдите на Fandora Gold, чтобы узнать, кто поставил Вам лайк.</p>
						</div>
									...
									<div className='topProfileInfo'>
										<div className='userInfo'>
											<div className='userName'>
												...
												<span className='age'>{item.useAge}</span>
											</div>
											<div className='timeStamp'>
												<span>Осталось {item.timeStamp}</span>
												<span className='hoursMark'>ч.</span>
											</div>
										</div>
