		...
		<div className='page Settings'>
			...
			<div className='pageItems'>
				<div className='planSettings'>
					<div className='planOption plan-vip'>
						<div className='wrapper'>
							...
							<div className='planDescription'>
								<p>Приоритет лайков, просмотр лайков и другое!</p>
					...
					<div className='planOption plan-gold'>
						<div className='wrapper'>
							...
							<div className='planDescription'>
								<p>Узнай, кто тебя лайкнул, и многое другое!</p>
					...
					<div className='planOption plan-plus'>
						<div className='wrapper'>
							...
							<div className='planDescription'>
								<p>Безлимит лайков и многое другое!</p>
					...
					<div className='boost'>
						<div className='wrapper'>
							...
							<div
								className='plusBtn'
								onClick={() => {
									dispatch(boostModalState('open-boostModal'));
								}}
							>
								<SVGIcon name='plusBtn' size={30} />
							</div>
				...
				<div className='accountSettings'>
					<div className='wrapper'>
						<div className='title'>
							<h3>Настройки аккаунта</h3>
						</div>
						<div className='subtitle'>
							<p>Подтвержденный номер телефона и адрес электронной почты помогают защитить Ваш аккаунт.</p>
						</div>
					...
					<ul>
						<li style={{ alignItems: 'start' }}>
							<div className='itemWrapper'>
								...
								<div className='value'>
									<div className='item'>
										<p>Мое текущее местоположение</p>
						...
						<li>
							...
							<div className='optionDescription'>
								<p>Глобальный режим позволяет искать пары как неподалёку от вас, так и по всему миру.</p>
							</div>
						</li>
					</ul>
				</div>
				<div className='title gold'>
					<h3>Кого видишь ты</h3>
				...
				<div className='listWrapper'>
					<ul>
						<li>
							<div className='itemWrapper'>
								<div className='description'>
									<span>Оптимальные рекомендации</span>
								</div>
								<div className='value'>
									<Checkbox />
								</div>
							...
							<div className='optionDescription'>
								<p>Показываются наиболее подходящие тебе люди (по умолчанию)</p>
							</div>
						</li>
						<li>
							<div className='itemWrapper'>
							...
							<div className='optionDescription'>
								<p>Первыми показываются самые активные за последнее время пользователи</p>
							</div>
						</li>
					</ul>
				</div>
				<div className='title gold'>
					<h3>Управление видимостью</h3>
					{/* <div className="plusSign">
                        <span>
                            PLUS
                        </span>
				...
				<div className='listWrapper'>
					<ul>
						<li>
							<div className='itemWrapper'>
								<div className='description'>
									<span>Активировать находки</span>
								</div>
								<div className='value'>
									<ToggleBtn />
								</div>
				...
				<div className='title '>
					<h3>Управляй кто может тебе писать</h3>
				</div>
				<div className='listWrapper'>
					<ul>
						<li>
				...
				<div className='listWrapper'>
					<ul>
						<li>
							<div className='itemWrapper'>
								<div className='description'>
									<span>Отправлять уведомления “Просмотрено”</span>
								</div>
								<div className='value'>
									<ToggleBtn />
								</div>
							...
							<div className='optionDescription'>
								<p>Если ты отключишь данную функцию, твои пары не смогут активировать уведомления «Просмотрено» в твоих переписках.</p>
							</div>
						</li>
					</ul>
				</div>
				...
				<div className='listWrapper'>
					<ul>
						<li>
							<div className='itemWrapper'>
								<div className='description'>
									<span>Заблокировать контакты</span>
								</div>
								<div className='value'>
									<div className='text'>
										<span>Выбрать</span>
							...
							<div className='optionDescription'>
								<p>Выберите из списка контактов людей, с которыми вы не хотите пересекаться в Tinder.</p>
							</div>
						</li>
					</ul>
				</div>
				<div className='title '>
					<h3>События с вопросами</h3>
				</div>
				<div className='listWrapper'>
					<ul>
						<li>
							<div className='itemWrapper'>
								<div className='description'>
									<span>Управлять событиями с вопросами</span>
								</div>
								<div className='value'>
									<div className='text'>
										<span>Настройки</span>
				...
				<div className='listWrapper'>
					<ul>
						<li>
							<div className='itemWrapper'>
								<div className='description'>
									<span>Управление топ-профилями</span>
								</div>
								<div className='value'>
									<div className='text'>
										<span>Настройки</span>
				...
				<div className='listWrapper'>
					<ul>
						<li>
							<div className='itemWrapper'>
								<div className='description'>
									<span>Управлять личными сообщениями</span>
								</div>
								<div className='value'>
									<div className='text'>
										<span>Настройки</span>
				...
				<div className='listWrapper'>
					<ul>
						<li>
							<div className='itemWrapper'>
								<div className='description'>
									<span>Управлять взрывом свайпов</span>
								</div>
								<div className='value'>
									<div className='text'>
										<span>Настройки</span>
				...
				<div className='listWrapper'>
					<ul>
						<li>
							...
							<div className='optionDescription'>
								<p>Создайте имя пользователя и поделитесь им с другими. Пусть люди со всего мира заценят вас в Fondora.</p>
							</div>
						</li>
					</ul>
				</div>
				...
				<div className='listWrapper'>
					<ul>
						...
						<li>
							...
							<div className='optionDescription'>
								<p>Выберите, какие уведомления будут видны внутри приложения.</p>
							</div>
						</li>
					</ul>
				</div>
				<div className='title '>
					<h3>Поделиться Fondora</h3>
				</div>
