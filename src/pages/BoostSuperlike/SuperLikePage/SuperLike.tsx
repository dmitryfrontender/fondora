				...
				<div className='superLikeWrapper'>
					...
					<div className='superLikeBanner'>
						<div className='bannerTitle'>
							<span className='colorText'>Стань заметнее</span>
							<span>&nbsp; с суперлайком!</span>
						</div>
					...
					<div className='cardWrapper'>
						<div className='title'>
							<h3>У тебя будет в 3 раза больше шансов найти пару!</h3>
						</div>
						<div className='itemWrapper'>
							<div className='item'>
								...
								<div className='quantityLikes'>
									<h2>15 Суперлайков</h2>
								</div>
								<div className='description'>
									<span>3,13 $ / за 1шт.</span>
								</div>
					...
					<div className='goldPlanBanner'>
						...
						<div className='description'>
							<p>Включает 5 бесплатных суперлайков в неделю</p>
							<div className='goBtn'>
								<span>Перейти</span>
							</div>
						</div>
