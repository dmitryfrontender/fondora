...
export const sliderProfiles: ISliderProfile[] = [
	{
		...
		userDescription: 'Не люблю длинные переписки( лучше увидимся на нашем первом свидании. Пригласить можешь в заведение. Не люблю длинные переписки( лучше увидимся на нашем первом свидании. Пригласить можешь в заведение. Не люблю длинные переписки( лучше увидимся на нашем первом свидании. Пригласить можешь в заведение. Не люблю длинные переписки( лучше увидимся на нашем первом свидании. Пригласить можешь в заведение. ',
		timeStamp: 2
	},
	{
		id: 2,
