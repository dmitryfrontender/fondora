    ...
    const buttonBg = (background: string) => {
        switch (background) {
            ...
            case 'blue':
                return {
                    'borderRadius': '30px',
                    'background': 'linear-gradient(135.00deg, rgb(55, 63, 255) 0.009%,rgb(34, 202, 255) 100.009%),linear-gradient(135.00deg, rgb(132, 9, 56) -0.15%,rgb(242, 34, 113) 99.85%),linear-gradient(135.00deg, rgb(24, 25, 32) 0%,rgb(15, 15, 19) 100%)'
                }
