									...
									<animated.div className={`GamePadBlockItem`} key={sliderProfile.id} {...bind(i)}>
										...
										{i === 0 && (
											<div className='GamePadPanel'>
												<div className='GamePadPanelBackground' onClick={() => handleProfileVisibility(true)} aria-hidden="true">
												...
												<div className='GamePadPanelButtons'>
													<div className={`GamePadPanelButtonsItem item-big ${approved === 'declined' ? 'declined' : ''}`} onClick={() => handleDecline()} aria-hidden='true'>
