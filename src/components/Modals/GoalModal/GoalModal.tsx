			...
			<div className='GoalModal Modal'>
				...
				<div className='modalWrapper'>
					<div className='tittle'>
						<h2>Представляем ЦельКа</h2>
					</div>
					<span className='description'>Новый увлекательный способ знакомиться и обзаться с интересными людьми.</span>
					<div
						className='btn'
						onClick={() => {
							dispatch(setGoalPageModal(false));
						}}
					>
