                ...
                <div className="itemWrapper">
                    <div className="item">
                        ...
                        <div className="description">
                                <div className="main">
                                    <span>
                                        Удалить из пар: {userName}
                                    </span>
                                </div>
                                <div className="sub">
                                    <span>
                                        Больше не хочешь общаться? Удали пользователя их пар.
                                    </span>
                                </div>
                            </div>
                    </div>
                    <div className="item">
                        ...
                        <div className="description">
                            ...
                            <div className="sub">
                                <span>
                                    Вы больш не будете видеть друг друга.
                                </span>
                            </div>
                        </div>
                    </div>
                    <div className="item" onClick={() => {
                        ...
                        <div className="description">
                            ...
                            <div className="sub">
                                <span>
                                    Расскажи, что произошло, и мы изучим твою заявку.
                                </span>
                            </div>
                        </div>
                    </div>
                    <div className="item">
                        ...
                        <div className="description">
                                <div className="main">
                                    <span>
                                        Перейти в центр безопасности
                                    </span>
                                </div>
                                <div className="sub">
                                    <span>
                                        Советы и инструменты по безопасности. Береги себя.
                                    </span>
                                </div>
                            </div>
                    </div>
