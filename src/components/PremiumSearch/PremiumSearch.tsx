			...
			<div className='PremiumSearch'>
				<div className='wrapper-block'>
					...
					<div className='description'>
						<p>Настройки показывают людей со схожими предпочтениями, но не ограничивают предложения: ты по-прежнему будешь видеть людей с другими интересами.</p>
					</div>
					<div className='listWrapper'>
						<ul>
							<li className='quantityPhotos'>
								<div className='text'>
									<p>Минимальное количество фото</p>
								</div>
